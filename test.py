...
from strategies import MeanReversion, OfflineMeanReversion
...
backtester.run(
    MeanReversion(
        calibration_window=20, entry_threshold=1.2,
        exit_threshold=0.2, model_trust=20.0, 
        mu_ewma_alpha=0.1, jump_z_threshold=5.0,
    ),
